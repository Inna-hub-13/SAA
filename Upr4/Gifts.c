...
void separate_gifts2(int*, int);

int main() {

    int gifts[N] = {3, 4, 5, 5, 1};
    separate_gifts(gifts, N);
    separate_gifts2(gifts, N);
...
void separate_gifts2(int* gifts, int size) {
    ...
    *sums = 1;
    ...
    for(i = j; i > 0; i -= *(sums + i))
        printf("%d ", *(sums + i));

    printf("\n");
    printf("The other gifts are for the second\n");
}